...
void main() {
  group('RegularUtils.extractVersion', () {
    test('release 路径含版本号', () {
      expect(
        RegularUtils.extractVersion(
    ...
    test('带预发布/构建元数据只取主版本段', () {
      expect(
        RegularUtils.extractVersion('https://x/v1.2.3-beta.1+build.5/file'),
        '1.2.3',
      );
    });

    test('无版本号返回 null', () {
      expect(RegularUtils.extractVersion('https://x.com/latest/bricks.zip'), isNull);
    });
  });
